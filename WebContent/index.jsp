					...
					<tr>
						...
						<%
							for(int i =0;i<10;i++){
								...
								if(value == -1){
									hit = " hit=\"\"";
									valueStr = "<span class=\"ball_5\">"+value+"</span>";
								}
						%>
